...
func LoginSuccessResponse(c *gin.Context, user interface{}, tokens interface{}) {
	...
	SuccessResponse(c, http.StatusOK, data, "Login successful")
}

func RegisterSuccessResponse(c *gin.Context, user interface{}) {
	data := gin.H{
		"user": user,
	}
	SuccessResponse(c, http.StatusCreated, data, "Registration successful")
}
...
func ProfileUpdateSuccessResponse(c *gin.Context, user interface{}) {
	...
	SuccessResponse(c, http.StatusOK, data, "Profile updated successfully")
}

func RoleCreatedSuccessResponse(c *gin.Context, role interface{}) {
	data := gin.H{
		"role": role,
	}
	SuccessResponse(c, http.StatusCreated, data, "Role created successfully")
}

func RoleUpdatedSuccessResponse(c *gin.Context, role interface{}) {
	data := gin.H{
		"role": role,
	}
	SuccessResponse(c, http.StatusOK, data, "Role updated successfully")
}

func RoleDeletedSuccessResponse(c *gin.Context) {
	SuccessResponse(c, http.StatusOK, nil, "Role deleted successfully")
}

func RoleAssignedSuccessResponse(c *gin.Context) {
	SuccessResponse(c, http.StatusOK, nil, "Role assigned successfully")
}
