...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const variantClasses = {
      default: "bg-background border-border focus:ring-primary/20 focus:border-primary",
      filled: "bg-background-secondary border-border focus:ring-primary/20 focus:border-primary"
    };
